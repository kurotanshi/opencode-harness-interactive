      ...
      steps: [
        {
          ...
          body: [
            ...
            '你需要能連上網，也建議先裝好 Git 和 Node.js。很多安裝方式和插件都會用到它們。',
            '正式安裝時，請看官方文件的最新指令。版本會更新，不要死背某一行舊指令。',
          ],
          note: '專有名詞：CLI 是「用文字下指令的視窗」；TUI 是「在終端機裡的彩色介面」。',
        },
        {
          type: 'flow',
          title: '三種系統，同一條路',
          body: ['流程相同，只是套件來源可能不同。'],
          flow: [
            { n: 1, title: '看官方安裝頁', body: 'Windows、macOS、Linux 都會有對應方式。選你的系統就好。' },
            { n: 2, title: '打開終端機', body: 'Windows 可用 PowerShell 或 Windows Terminal；macOS / Linux 用內建終端機。' },
            { n: 3, title: '啟動 OpenCode', body: '裝好後輸入 opencode。它會打開 TUI，也就是文字介面的工作台。' },
